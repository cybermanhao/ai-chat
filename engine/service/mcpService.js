...
export class MCPService {
    ...
    clientName;
    clientVersion;
    constructor(url = "", connectionType, serverCommand = "node", serverArgs = ["server.js"], clientName = "mcp-client", clientVersion = "1.0.0") {
            ...
            switch (this.connectionType) {
                case "STDIO":
                    if (typeof window !== "undefined")
                        throw new Error("STDIO not supported in browser");
